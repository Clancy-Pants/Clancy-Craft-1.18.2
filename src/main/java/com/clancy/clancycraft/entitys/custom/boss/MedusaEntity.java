...
public class MedusaEntity extends Monster implements RangedAttackMob,IAnimatable {
    private final ServerBossEvent bossInfo = new ServerBossEvent(getDisplayName(), BossEvent.BossBarColor.PINK, BossEvent.BossBarOverlay.NOTCHED_10);
    private AnimationFactory factory = new AnimationFactory(this);

    public MedusaEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    public void performRangedAttack(LivingEntity target, float distanceFactor) {
            PoisonArrow ice = new PoisonArrow(ModEntityTypes.POISON_ARROW.get(), this.level, this);
            ...
            this.playSound(SoundEvents.BOAT_PADDLE_WATER, 1.0F, 1.0F / (this.getRandom().nextFloat() * 0.4F + 0.8F));
