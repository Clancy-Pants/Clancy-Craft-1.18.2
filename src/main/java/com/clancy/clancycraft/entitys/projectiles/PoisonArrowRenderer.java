...
public class PoisonArrowRenderer extends EntityRenderer<PoisonArrow> {
    ...
    public PoisonArrowRenderer(EntityRendererProvider.Context manager) {
        super(manager);
        this.shadowRadius = 0.5F;
    }

    @Override
    public void render(PoisonArrow entity, float yaw, float partialTicks, PoseStack ms, MultiBufferSource buffers, int light) {
