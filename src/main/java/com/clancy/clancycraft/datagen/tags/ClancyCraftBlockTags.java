...
public class ClancyCraftBlockTags extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        tag(AXE).add(ModBlocks.RAINBOW_DOOR.get());
        tag(AXE).add(ModBlocks.RAINBOW_TRAPDOOR.get());
        tag(AXE).add(ModBlocks.RAINBOW_BUTTON.get());
        tag(AXE).add(ModBlocks.RAINBOW_PRESSURE_PLATE.get());
        ...
        tag(TinkerTags.Blocks.SEARED_BLOCKS).add(
                ModBlocks.LIGHT_SMELTERY_BLOCK.get()
        );
        tag(TinkerTags.Blocks.SMELTERY_WALL).add(
                ModBlocks.LIGHT_SMELTERY_BLOCK.get()
        );
